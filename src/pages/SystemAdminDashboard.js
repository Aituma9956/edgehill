...
const SystemAdminDashboard = () => {
  ...
  const navigationItems = [
    ...
    { id: 'users', label: 'User Management', icon: '👥', iconClass: 'fas fa-users' },
        ...
        <div className="sidebar-header">
          <div className="sidebar-logo-section">
            ...
            <div className="sidebar-branding">
              <p className="sidebar-portal-name">System Admin</p>
            </div>
          </div>
          <button 
  ...
  const renderDashboard = () => (
    <div className="main-content">
      ...
      <div className="page-header">
        ...
        <p className="page-subtitle">Welcome back, {user?.username}! Manage your system with complete control.</p>
      </div>
      ...
      <div className="stats-grid">
        ...
        <div className="stats-card">
          <div className="stats-value">{stats.activeUsers}</div>
          <div className="stats-label">Active Users</div>
          <div className="stats-icon">✅</div>
        </div>
        <div className="stats-card">
          <div className="stats-value">{stats.adminUsers}</div>
          <div className="stats-label">Admin Users</div>
          <div className="stats-icon">🔑</div>
        </div>
        <div className="stats-card">
          <div className="stats-value">{stats.studentUsers}</div>
          <div className="stats-label">Student Users</div>
          <div className="stats-icon">🎓</div>
        </div>
        <div className="stats-card">
        ...
        <div className="stats-card">
          <div className="stats-value">{stats.internationalStudents}</div>
          <div className="stats-label">International Students</div>
          <div className="stats-icon">🌍</div>
        </div>
        <div className="stats-card">
          <div className="stats-value">{stats.previousEhuStudents}</div>
          <div className="stats-label">Previous EHU Students</div>
          <div className="stats-icon">🎯</div>
        </div>
      </div>
      ...
      <div className="content-grid">
        <div className="info-panel">
          ...
          <div className="professional-list">
            <div className="list-item">
              ...
              <span className="list-text">Manage Users</span>
              <button 
            ...
            <div className="list-item">
              <span className="list-icon">📄</span>
              <span className="list-text">Manage Submissions</span>
              <button 
                className="btn secondary btn-sm"
        ...
        {/* <div className="info-panel">
          ...
          <div className="professional-list">
            <div className="list-item">
              <span className="list-icon">📈</span>
              <span className="list-text">User Growth</span>
              <span className="list-value">+{stats.totalUsers || 0}</span>
            </div>
            <div className="list-item">
              <span className="list-icon">🎯</span>
              <span className="list-text">Active Sessions</span>
              <span className="list-value">{stats.activeUsers || 0}</span>
            </div>
            <div className="list-item">
              <span className="list-icon">🔧</span>
            ...
            <div className="list-item">
              <span className="list-icon">⚡</span>
              <span className="list-text">Performance</span>
    ...
    <div className="main-content">
      ...
      <div className="search-filter-section">
        <div className="form-group">
          <label className="form-label">Search by User ID</label>
          <input
            type="number"
      ...
      <div className="dashboard-card">
        <div className="card-header">
          ...
          <span className="card-subtitle">{users.length} users found</span>
        </div>
        {usersLoading ? (
                      ...
                      {openDropdown === user.id && (
                        <div className="action-dropdown-row">
                          ...
                          <button
                            ...
                            className="dropdown-btn warning btn-sm"
        ...
        {!usersLoading && users.length === 0 && (
          <div className="empty-state">
            ...
            <div className="empty-state-description">Try adjusting your search criteria or refresh the data</div>
          </div>
        )}
      </div>
    </div>
      ...
      <main className="dashboard-main">
        ...
        <div className="main-header">
          <h1 className="header-title">
            {activeSection === 'dashboard' && 'System Administrator Dashboard'}
